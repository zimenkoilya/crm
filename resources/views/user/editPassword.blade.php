    	...
    	<div class="wrap flex__wrap f__start input__area">
    		...
    		<div class="wrap__right">
    			...
    			<div class="allWrapper">
                    <form @if ($isCharge) action="{{ route('charge.user.update_password') }}" @else action="{{ route('user.update_password') }}" @endif method="POST">
                        @csrf
                                        ...
                                        <div class="content__box">
                                            <div class="content__box__inner">
                                                <div class="content__input">
                                                    <div class="headline attention must">既存のパスワード</div>
                                                    <div class="input__box">
                                                        <input class="bgType" type="password" name="password_now">
                                                    </div>
                                                </div>
                                                <div class="content__input">
